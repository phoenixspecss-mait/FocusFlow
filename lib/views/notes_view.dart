      ...
      return Container(
        ...
        child: Row(
          ...
          children: List.generate(7, (i) {
            final d      = data[i];
            final height = d.minutes == 0
                ? 4.0
                : (d.minutes / maxMins) * 72;
            return Expanded(
              child: Padding(
...
class _TaskTileState extends State<_TaskTile> {
  ...
  Color _tagColor(String tag) {
    switch (tag) {
      case 'Design':  return const Color(0xFFB06EF5);
      case 'Dev':     return FocusFlowTheme.accent;
      case 'Meeting': return const Color(0xFFFF7043);
      default:        return FocusFlowTheme.success;
    }
  }
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color:
                    _done ? FocusFlowTheme.accent : Colors.transparent,
...
Future<bool> showLogoutDialog(BuildContext context) {
  return showDialog<bool>(
    ...
    builder: (context) => AlertDialog(
      ...
      title: Text('Log out',
          style: TextStyle(color: FocusFlowTheme.textPrimary, fontWeight: FontWeight.w700)),
